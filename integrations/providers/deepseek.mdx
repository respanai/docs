...
[DeepSeek](https://www.deepseek.com) is a Chinese AI lab building open-weight models competitive with frontier models at lower cost, including DeepSeek-V3 and DeepSeek-R1 for reasoning.
